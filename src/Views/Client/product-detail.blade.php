				...
				<div class="container">
					<div class="row small-gutters">
						...
						<nav class="col-xl-6 col-lg-7">
							...
							<div class="main-menu">
								<div id="header_menu">
									<a href="{{ url() }}"><img src="{{asset('assets/img/logo_black.svg')}}" alt=""
		...
		<main>
			<div class="container">
				...
				<div class="row mt-5">
					<div class="col-lg-6">
						<p>
							<a href="{{asset($product['img_thumbnail'])}}"><img
									src="{{asset($product['img_thumbnail'])}}" alt=""></a>
						</p>
					</div>
						...
						<div class="prod_info">
							...
							<div class="prod_options">
								<div class="row">
									<div class="row mb-4">
										<label
											class="col-xl-5 col-lg-5  col-md-6 col-6"><strong>Quantity</strong></label>
									...
									<div class="col-lg-5 col-md-6">
										<div class="price_main">
											@if (isset($product['price_regular']) && $product['price_regular'] !== null)
												...
												@else
													<span
														class="new_price">{{ number_format($product['price_regular'], 0, '', '.')}}đ</span>
												@endif
											@endif
										</div>
									</div>
